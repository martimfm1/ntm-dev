  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <ClickSpark
        ...
        duration={400}
      >
        <SpotlightCard spotlightColor="rgba(15, 15, 15, 0.585)">
          <InView
            variants={{
              ...
              <div className="text-amber-50 text-center">
                ...
                <h4 className="mb-15 text-lg">
                  ...
                  <span className="inline-block align-baseline">
                    ...
                    >
                      <Button
                        className="text-amber-50 text-lg p-0 m-0 h-auto align-baseline inline-flex"
                        variant="link"
                      >
                        <Link
                          href="/products"
                          className="cursor-pointer inline align-baseline"
                        >
                          products
                        </Link>
                      </Button>
          ...
          >
            ...
            >
              <div className="text-amber-50 text-center">
                ...
                <div className="w-full min-w-10 sm:max-w-lg md:min-w-xl md:max-w-xl lg:min-w-3xl lg:max-w-3xl border border-neutral-400/50 px-4 sm:px-6 py-5 rounded-3xl mx-auto">
                  <Accordion type="single" collapsible>
                    ...
                    <AccordionItem value="item-4">
                      <AccordionTrigger>
                        What is the time frame for maintaining the budget and
                        the amount paid?
                      </AccordionTrigger>
                      <AccordionContent>
                        What is the time frame for maintaining the budget and
        ...
        <footer className="bg-transparent border-t border-white/[0.08]">
          <div
